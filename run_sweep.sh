...
# ── Phase 2: SelfCheckGPT features (6 per sample, pre-computed via selfcheck_features.py) ──
run 55 "xgb-selfcheck-5fold"   "xgboost,selfcheck,cv"  AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold PROBE_FAMILY=xgboost USE_SELFCHECK=1
run 56 "xgb-selfcheck-manifold-all-5fold" "xgboost,selfcheck,manifold,all,cv" AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold PROBE_FAMILY=xgboost USE_SELFCHECK=1 USE_MANIFOLD=1 USE_PERPLEXITY=1 USE_HEURISTIC=1
run 57 "xgb-everything-5fold"  "xgboost,selfcheck,manifold,perhead,attn2prompt,all,cv" AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold PROBE_FAMILY=xgboost USE_SELFCHECK=1 USE_MANIFOLD=1 USE_ATTENTION=1 USE_ATTENTION_TO_PROMPT=1 USE_PER_HEAD_ATTN=1 USE_PERPLEXITY=1 USE_HEURISTIC=1
# ── Leave-one-out ablations on the everything-5fold config ──
run 58 "abl-no-selfcheck"   "ablation"     AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold PROBE_FAMILY=xgboost                USE_MANIFOLD=1 USE_ATTENTION=1 USE_ATTENTION_TO_PROMPT=1 USE_PER_HEAD_ATTN=1 USE_PERPLEXITY=1 USE_HEURISTIC=1
run 59 "abl-no-manifold"    "ablation"     AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold PROBE_FAMILY=xgboost USE_SELFCHECK=1                USE_ATTENTION=1 USE_ATTENTION_TO_PROMPT=1 USE_PER_HEAD_ATTN=1 USE_PERPLEXITY=1 USE_HEURISTIC=1
run 60 "abl-no-perhead"     "ablation"     AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold PROBE_FAMILY=xgboost USE_SELFCHECK=1 USE_MANIFOLD=1 USE_ATTENTION=1 USE_ATTENTION_TO_PROMPT=1                     USE_PERPLEXITY=1 USE_HEURISTIC=1
run 61 "abl-no-attn2prompt" "ablation"     AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold PROBE_FAMILY=xgboost USE_SELFCHECK=1 USE_MANIFOLD=1 USE_ATTENTION=1                              USE_PER_HEAD_ATTN=1 USE_PERPLEXITY=1 USE_HEURISTIC=1
run 62 "abl-no-attention"   "ablation"     AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold PROBE_FAMILY=xgboost USE_SELFCHECK=1 USE_MANIFOLD=1                                                              USE_PERPLEXITY=1 USE_HEURISTIC=1
run 63 "abl-no-perplexity"  "ablation"     AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold PROBE_FAMILY=xgboost USE_SELFCHECK=1 USE_MANIFOLD=1 USE_ATTENTION=1 USE_ATTENTION_TO_PROMPT=1 USE_PER_HEAD_ATTN=1                  USE_HEURISTIC=1
run 64 "abl-no-heuristic"   "ablation"     AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold PROBE_FAMILY=xgboost USE_SELFCHECK=1 USE_MANIFOLD=1 USE_ATTENTION=1 USE_ATTENTION_TO_PROMPT=1 USE_PER_HEAD_ATTN=1 USE_PERPLEXITY=1
# ── Drop-perplexity sweep (abl-no-perplexity at 83.17% becomes new floor) ──
run 65 "no-ppl-no-heur"     "ablation"     AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold PROBE_FAMILY=xgboost USE_SELFCHECK=1 USE_MANIFOLD=1 USE_ATTENTION=1 USE_ATTENTION_TO_PROMPT=1 USE_PER_HEAD_ATTN=1
run 66 "no-ppl-no-attn2prompt" "ablation"  AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold PROBE_FAMILY=xgboost USE_SELFCHECK=1 USE_MANIFOLD=1 USE_ATTENTION=1                              USE_PER_HEAD_ATTN=1 USE_HEURISTIC=1
run 67 "no-ppl-no-perhead"  "ablation"     AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold PROBE_FAMILY=xgboost USE_SELFCHECK=1 USE_MANIFOLD=1 USE_ATTENTION=1 USE_ATTENTION_TO_PROMPT=1                     USE_HEURISTIC=1
run 68 "no-ppl-no-attention" "ablation"    AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold PROBE_FAMILY=xgboost USE_SELFCHECK=1 USE_MANIFOLD=1                                                              USE_HEURISTIC=1
run 69 "minimal-sc-manif"   "ablation"     AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold PROBE_FAMILY=xgboost USE_SELFCHECK=1 USE_MANIFOLD=1
run 70 "no-ppl-mlp"         "ablation,mlp" AGG_STRATEGY=last_token PROBE_ARCH=mlp_1h_256 SPLIT_STRATEGY=5fold                       USE_SELFCHECK=1 USE_MANIFOLD=1 USE_ATTENTION=1 USE_ATTENTION_TO_PROMPT=1 USE_PER_HEAD_ATTN=1 USE_HEURISTIC=1
